...
from data.models.models import Mnist10xS
...
model = Mnist1xS(input_size=784, hidden_size=50, output_size=10)

# Load the state_dict into the model
pytorchFile = "data/models/mnist/mnist_model_1x50.pth"
...
model.eval()
pytorch2nnet(model=model, nnetFile="data/models/mnist/mnist-1x50.nnet", input_min=0, input_max=255)
