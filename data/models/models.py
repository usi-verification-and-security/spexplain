...
class Mnist10xS(nn.Module):

    def __init__(self, hidden_size, input_size=784, output_size=10):
        super(Mnist10xS, self).__init__()
        self.l1 = nn.Linear(input_size, hidden_size)
        self.l2 = nn.Linear(hidden_size, hidden_size)
        self.l3 = nn.Linear(hidden_size, hidden_size)
        self.l4 = nn.Linear(hidden_size, hidden_size)
...
class Mnist8xS(nn.Module):

    def __init__(self, hidden_size, input_size=784, output_size=10):
        super(Mnist8xS, self).__init__()
        self.l1 = nn.Linear(input_size, hidden_size)
        self.l2 = nn.Linear(hidden_size, hidden_size)
        self.l3 = nn.Linear(hidden_size, hidden_size)
        self.l4 = nn.Linear(hidden_size, hidden_size)
...
class Mnist6xS(nn.Module):

    def __init__(self, hidden_size, input_size=784, output_size=10):
        super(Mnist6xS, self).__init__()
        self.l1 = nn.Linear(input_size, hidden_size)
        self.l2 = nn.Linear(hidden_size, hidden_size)
        self.l3 = nn.Linear(hidden_size, hidden_size)
        self.l4 = nn.Linear(hidden_size, hidden_size)
...
class Mnist1xS(nn.Module):

    def __init__(self, hidden_size, input_size=784, output_size=10):
        super(Mnist1xS, self).__init__()
        self.l1 = nn.Linear(input_size, hidden_size)
        # self.l2 = nn.Linear(hidden_size, hidden_size)
        self.relu = nn.ReLU()
        self.l_out = nn.Linear(hidden_size, output_size)
