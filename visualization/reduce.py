...
def plot_multiple_projection(plot_points, bounds, projection_direction, title=f"Exp", keys=None, axis_labels=None, ax=None):
    if keys is None:
...
def plot_compare_projections(explanations_list, vars, bounds, projection_direction=(0,1), keys=None,
    ...
    plot_multiple_projection(plot_spaces, plot_bounds, (a+1,b+1), keys=keys, axis_labels=axis_labels, ax=ax, title=title)
