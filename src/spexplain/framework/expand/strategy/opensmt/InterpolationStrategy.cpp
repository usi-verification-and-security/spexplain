...
void InterpolationStrategy::executeInit(Explanations & explanations, Network::Dataset const & data, Sample::Idx idx) {
...
void InterpolationStrategy::executeBody(Explanations & explanations, Network::Dataset const &, Sample::Idx idx) {
