...
public:
    ...
    void setEncodingNeuronActivationVars(bool val = true) { _encodingNeuronActivationVars = val; }
    ...
    bool encodingNeuronActivationVars() const {
        return _encodingNeuronActivationVars.value_or(defaultEncodingNeuronActivationVars());
    }
...
protected:
    ...
    virtual bool defaultEncodingNeuronActivationVars() const;
...
private:
    ...
    std::optional<bool> _encodingNeuronActivationVars;
